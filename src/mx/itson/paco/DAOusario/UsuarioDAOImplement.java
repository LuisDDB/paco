 ...
 */
package mx.itson.paco.DAOusario;
...
import mx.itson.paco.entidades.Usuario;
...
public class UsuarioDAOImplement {
    ...
    public UsuarioDAOImplement(Connection _connection) {
    ...
    public boolean agregar(Object _object) {
        ...
        Usuario usuario = (Usuario) _object;
        ...
        try {
            ...
            _statement.setString(1, usuario.getNombre());
            _statement.setString(2, usuario.getDireccion());
            _statement.setString(3, usuario.getCorreoElectronico());
            _statement.setString(4, usuario.getTelefono());
            _statement.setString(5, usuario.getContacto());
            _statement.setString(6, usuario.getRfc());
            _statement.setBoolean(7, usuario.isEliminado());
